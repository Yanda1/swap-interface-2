...
type Action = Verification | Button | KycStatus | ThemeAction;
...
const button: ButtonType = {
  // ButtonType can be designed easier with keyof typeof
  ...
  CHECK_KYC: { color: 'green', text: buttonInfo.CHECK_KYC },
};
